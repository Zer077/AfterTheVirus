            ...
            switch(i){
                case 1:
                    for(int z1=0;z1<5;z1++){
                        Zombie zombie1 = new Zombie1(0, "Z1", escenario, 0, 0);
                        MazoZombie.add(zombie1);
                    }
                    break;
                case 2:
                    for(int z1=0;z1<4;z1++){
                        Zombie zombie2 = new Zombie2(0, "Z2", escenario, 0, 0);
                        MazoZombie.add(zombie);
                    }
                    break;
                case 3:
                    for(int z1=0;z1<3;z1++){
                        Zombie zombie3 = new Zombie3(0, "Z3", escenario, 0, 0);
                        MazoZombie.add(zombie);
                    }
                    break;
                case 4:
                    for(int z1=0;z1<2;z1++){
                        Zombie zombie4 = new Zombie4(0, "Z4", escenario, 0, 0);
                        MazoZombie.add(zombie);
                    }
                    break;
            }
