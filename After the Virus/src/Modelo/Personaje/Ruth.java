...
public class Ruth extends Personaje {
    ...
    public Ruth(Escenario escenario) {
        ...
        escenario.mazoJugador.getMazoJugador().add(new Shotgun(0, nombre, escenario, 0, 0));
        escenario.mazoJugador.getMazoJugador().add(new ConcussionGrenade(0, nombre, escenario, 0, 0));
        escenario.mazoJugador.getMazoJugador().add(new Entrenchment(0, nombre, escenario, 0, 0));
        escenario.mazoJugador.getMazoJugador().add(new WeaponSkill(0, nombre, escenario, 0, 0));
